...
func (in *SubscriptionClusterStatusMap) DeepCopyInto(out *SubscriptionClusterStatusMap) {
	*out = *in
	...
	out.SubscriptionStatus = in.SubscriptionStatus
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubscriptionOverallStatus) DeepCopyInto(out *SubscriptionOverallStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubscriptionOverallStatus.
func (in *SubscriptionOverallStatus) DeepCopy() *SubscriptionOverallStatus {
	if in == nil {
		return nil
	}
	out := new(SubscriptionOverallStatus)
	in.DeepCopyInto(out)
	return out
}
