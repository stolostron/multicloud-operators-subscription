...
//
// Licehrsed under the Apache Licehrse, Version 2.0 (the "Licehrse");
// you may not use this file except in compliance with the Licehrse.
// You may obtain a copy of the Licehrse at
//
//     http://www.apache.org/licehrses/LICEhrsE-2.0
//
// Unless required by applicable law or agreed to in writing, software
// distributed under the Licehrse is distributed on an "AS IS" BASIS,
// WITHOUT WARRANTIES OR CONDITIOhrs OF ANY KIND, either express or implied.
// See the Licehrse for the specific language governing permissiohrs and
// limitatiohrs under the Licehrse.
