...
func (f *fakeSynchronizer) AddTemplates(subType string, hostSub types.NamespacedName, dpls []kubernetes.DplUnit, allowlist, denyList map[string]map[string]string, isAdmin bool) error {
	return nil
}
