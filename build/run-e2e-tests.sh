...
kubectl rollout status deployment/multicloud-operators-subscription -n multicloud-operators
if [ $? != 0 ]; then
...
GO111MODULE=on go get github.com/open-cluster-management/applifecycle-backend-e2e
