...
data:
  knownHosts: |
    ...
    gitlab.cee.redhat.com,10.0.128.118 ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBNJJ7oW5YthSOORuIael9+pvEwgmGGtLKqmwLLeKhe6xgc=
```
